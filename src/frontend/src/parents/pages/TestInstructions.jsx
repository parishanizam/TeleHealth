...
export default function TestInstructions() {
  ...
  const handleStart = async () => {
    await startRecording({ audioDeviceId: selectedMicId, videoDeviceId: selectedCameraId });
    ...
    <div className="h-screen flex flex-col bg-white overflow-hidden">
      ...
      <div className="flex flex-2 pt-[100px] px-16 items-center justify-center gap-12">
        ...
        <div className="w-1/3 flex flex-col items-center justify-center p-6 bg-blue-50 rounded-xl shadow-lg">
          <img src={puppy2} alt="Motivational Puppy" className="w-3/4 rounded-lg" />
          <h2 className="text-4xl font-bold text-blue-600 text-center mb-4">Are you ready to begin?</h2>
