...
\begin{itemize}
    \item 
      ...
      \textbf{Source:} TA \\
      \textbf{Changes Made:} Imrpoved the format of the two FMEA tables in the document using \verb|\multirow|. The hazard analysis tables were never directly referred to in the body of the document, so no references of the table were added.\\
      ...
      \textbf{Source:} TA \\
      \textbf{Changes Made:} Clarified and expanded on several recommended actions in the FMEA table, and added recommended actions using encryption for the database component. \\
      ...
      \textbf{Changes Made:} Changed UI to User-Facing Application and reorganized video/audio recording and analysis components for clarity. \\
