...
\begin{table}[hp]
    ...
    03/23/2025 & 2.2 & Parisha Nizam & Implemented TA Feedback: \href{https://github.com/parishanizam/TeleHealth/issues/181}{Numbered Goals for Better Tracability Pg 3} \\
    \bottomrule
    \end{tabularx}
\end{table}
