...
\begin{tabularx}{\textwidth}{|p{10cm}|X|}
  \hline
  \textbf{Application Development Revision 0 Tasks} & \textbf{Deadline} \\
  \hline
  Frontend App Setup for Video/Audio Integration & Oct 15, 2024 \\
  \hline
  Video Capture \& Storage Module Development (Database \& Server Set Up) & Oct 25, 2024 \\
  \hline
  Data Security and Encryption Integration & Oct 28, 2024 \\
  \hline
  Basic Machine Learning Integration & Nov 5, 2024 \\
  \hline
  Video Testing in Controlled Setting for POC & Nov 5, 2024 \\
  \hline
  Proof of Concept Demo & Nov 11-22, 2024 \\
  \hline
  Application Frontend Design & Nov 10, 2024 \\
  \hline
  Audio Capture \& Storage Module Development & Nov 20, 2024 \\
  \hline
  Application Frontend Development First Iteration Complete (Application Integration, Login \& Authentication System) & Nov 25, 2024 \\
  \hline
  Deep Training of Machine Learning Model & Dec 16, 2024 \\
  \hline
\end{tabularx}

\begin{tabularx}{\textwidth}{|p{10cm}|X|}
  \hline
  \textbf{Application Development Revision 1 Tasks} & \textbf{Deadline} \\
  \hline
  Authentication and Access Check & Jan 15,2025 \\
  \hline 
  Usability Survey & Feb 20, 2025 \\
  \hline 
  User Interface Completion/Iteration & Feb 30, 2025 \\
  \hline 
  Unit Testing & March, 4, 2025 \\
  \hline 
  Code Refinement & April 1, 2025 \\
  \hline
\end{tabularx}
...
\begin{enumerate}
  ...
  \subitem Parisha Nizam: 
  Knowledge to Acquire: Deepen understanding of software architecture principles, especially related to building scalable web applications and usage of relevant frameworks for a React-based Application.
  Skill to Develop: Enhance skills in designing RESTful APIs and integrating them with frontend applications to facilitate data flow between components. Understanding how to use EXPO, and additional tools with React.
