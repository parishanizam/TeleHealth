...
03/20/2025 & 2.2 & Jasmine Sun-Hu & Implemented Peer Feedback: \href{https://github.com/parishanizam/TeleHealth/issues/153}{added additional failure modes/ recommended actions for video recording component}\\
\bottomrule
\end{tabularx}
\end{table}
