...
03/23/25 & 2.1 & Parisha Nizam & Updated Technology Table \\
\bottomrule
\end{tabularx}
\end{table}
...
\begin{tabularx}{\textwidth}{|X|X|}
  ...
  \hline
  React Native and Tailwind & Will be used for styling the site \\
  \hline
  ...
  \hline
  AWS - S3  & Store all data in S3 Buckets. \\
  \hline
  Netlify &  Will be used to deploy the frontend of the application \\
  \hline
  Render &  Will be used to deploy the backend of the application \\
  \hline
  Deepgram & Using Deepgram to create Bias Detection algorithm \\
  \hline
\end{tabularx}
