...
\begin{table}[!ht]
  ...
  \begin{tabular}{|l|l|l|l|l|l|l|l|l|l|l|l|l|l|l|l|l|}
  \hline
      ~ & FR-ST-VDA3 & FR-ST-DPD1 & FR-ST-DPD2 & FR-ST-DPD3 & FR-ST-DPD4 & FR-ST-SS1 & FR-ST-SS2 & FR-ST-SS3 & FR-ST-SS4 & FR-ST-SS5 & FR-ST-AI1 & FR-ST-AI2 & FR-ST-AI3 & FR-ST-AI4 & FR-ST-AI5 & FR-ST-AI6 \\ \hline
      FR-A1 & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ \\ \hline
      FR-A2 & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ \\ \hline
      FR-A3 & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ \\ \hline
      FR-A4 & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ \\ \hline
...
\begin{table}[!ht]
  ...
  \hline
      System test  & LF-ST-LFR1 & LF-ST-LFR2 & UH-ST-EOU1 & UH-ST-PI1 & UH-ST-LI2 & PR-ST-SL1 & PR-ST-SL2 & PR-ST-SL3 & PR-ST-PA1 & PR-ST-PA3 & PR-ST-PA4 & PR-ST-RFT1 & PR-ST-RFT2 & PR-ST-CR1 & PR-ST-CR2 & PR-ST-SE1 & PR-ST-LR1 \\ \hline
      LF-AR1 & X & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ \\ \hline
      LF-AR2 & X & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ \\ \hline
      LF-AR3 & ~ & X & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ \\ \hline
      LF-AR4 & X & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ \\ \hline
...
\begin{table}[!ht]
  ...
  \hline
      System test  & PR-ST-LR2 & OE-ST-EPE1 & EO-ST-WE1 & OE-ST-IA1 & MS-ST-MSA1 & MS-ST-MSA2 & MS-ST-MSA3 & CU-ST-CUR1 & CU-ST-CUR1 & SR-ST-AC1 & SR-ST-AC2 & SR-ST-AC3 & SR-ST-AC4 & SR-ST-IM1 & CR-ST-D1 & SR-ST-P1 & SR-ST-P2 & SR-ST-P3 \\ \hline
      LF-AR1 & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ \\ \hline
      LF-AR2 & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ \\ \hline
      LF-AR3 & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ \\ \hline
      LF-AR4 & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ \\ \hline
