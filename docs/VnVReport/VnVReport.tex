...
\begin{table}[hp]
  ...
  \end{itemize}\\
  3/23/25 & 2.0 & Parisha Nizam & \begin{itemize}[leftmargin=*]
  ...
  \end{itemize}\\
  4/03/25 & 2.1 & Jasmine Sun-Hu & \begin{itemize}[leftmargin=*]
    \item Implemented TA Feedback: \href{https://github.com/parishanizam/TeleHealth/issues/617}{Improved actual results wording in LF test cases}
  \end{itemize}\\
