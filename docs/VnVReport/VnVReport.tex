...
\begin{mdframed}[linewidth=0.5mm] \par
  ...
  \textbf{Expected Output:} User answers questions in the Usability Survey (6.2), and results are culminated and averaged.\\
  Averages should be at least 'Agree' on the answer scale \par
  \textbf{Actual Output:} User answers were on average at least 'Agree' on the answer scale across all rating questions in the usability survey (Figure 1).\par
  \textbf{Expected and Actual Output Match:} True \par
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{UsabilityTestResults.png}
...
\begin{mdframed}[linewidth=0.5mm] \par
  ...
  \textbf{Actual Output:} The assessment can be completed in either English and Mandarin\par
  \textbf{Expected and Actual Output Match:} True \par
...
\begin{mdframed}[linewidth=0.5mm] \par
  ...
  \textbf{Actual Output:} The actual result is the system's displayed elements scaled, to the satisfaction of 60\% of users (Figure 2)\par
  \textbf{Expected and Actual Output Match:} True \par
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{UsabilityTestResults2.png}
