...
\begin{itemize}
  \item FR-ST-SS1
    \begin{mdframed}[linewidth=0.5mm]
      ...
      the hardware setup to ensure they are prepared. \par
  ...
  \item FR-ST-SS4
    \begin{mdframed}[linewidth=0.5mm]
      ...
      \textbf{Test Case Derivation:} Providing a tutorial ensures that users understand the assessment process,
       improving accuracy and compliance. \par
      \textbf{How the test will be performed:}
      \begin{enumerate}[noitemsep]
...
\begin{itemize}
  \item FR-ST-AI1
    \begin{mdframed}[linewidth=0.5mm]
      ...
      \textbf{Test Case Derivation:} Audio and video recording are essential for capturing user responses accurately,
       and an indicator reassures users that recording is in progress. \par
      \textbf{How the test will be performed:}
      \begin{enumerate}[noitemsep]
  ...
  \item FR-ST-AI3
    \begin{mdframed}[linewidth=0.5mm]
      ...
      \textbf{Test Case Derivation:} Presenting options ensures the user can make a response selection based
       on the question, system must mark answer select as right or wrong \par
      \textbf{How the test will be performed:}
      \begin{enumerate}[noitemsep]
  ...
  \item FR-ST-AI4
    \begin{mdframed}[linewidth=0.5mm]
      ...
      \textbf{Test Case Derivation:} Visual confirmation of selection minimizes user error and allows
       the user to review their choice before confirmation. \par
      \textbf{How the test will be performed:}
      \begin{enumerate}[noitemsep]
  ...
  \item FR-ST-AI5
    \begin{mdframed}[linewidth=0.5mm]
      ...
      accuracy in user responses. \par
      \textbf{How the test will be performed:}
      \begin{enumerate}[noitemsep]
  ...
  \item FR-ST-AI6
    \begin{mdframed}[linewidth=0.5mm]
      ...
      synchronizing recordings and analyzing response timing. \par
      \textbf{How the test will be performed:}
      \begin{enumerate}[noitemsep]
  ...
  \item FR-ST-AI7
    \begin{mdframed}[linewidth=0.5mm]
      ...
      the assessment and allows users to exit confidently. \par
      \textbf{How the test will be performed:}
      \begin{enumerate}[noitemsep]
