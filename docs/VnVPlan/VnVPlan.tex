...
\begin{itemize}
  ...
  \item FR-ST-SS4: \textbf{Display Assessment Tutorial from HomePage}
  \begin{mdframed}[linewidth=0.5mm]
      \textbf{Purpose:} Confirms users are shown a helpful step-by-step tutorial from homepage. \par
      \textbf{Type:} Dynamic, Manual \par
      \textbf{Initial State:} User has successfully been brought to parent homepage. \par
      \textbf{Input:} User proceeds to the tutorial section after navigating the homepage. \par
  \item FR-ST-SS4: \textbf{Display Assessment Tutorial from HomePage}
  \begin{mdframed}[linewidth=0.5mm]
      \textbf{Purpose:} Confirms users are shown a helpful step-by-step tutorial from homepage. \par
      \textbf{Type:} Dynamic, Manual \par
      ...
      \textbf{How the test will be performed:}
      \begin{enumerate}[noitemsep]
        \item Navigated to homepage after logging in.
        \item Verify that the system automatically navigates the user to a tutorial section upon selecting tutorials from homepage.
        \item Navigated to homepage after logging in.
        \item Verify that the system automatically navigates the user to a tutorial section upon selecting tutorials from homepage.
  ...
  \begin{mdframed}[linewidth=0.5mm]
      \textbf{Purpose:} Verifies that users can begin the assessment after they complete all setup steps, including the tutorial. \par
      \textbf{Type:} Dynamic, Manual \par
  \item FR-ST-SS5: \textbf{Begin Assessment After Tutorial Completion}
  \begin{mdframed}[linewidth=0.5mm]
      \textbf{Purpose:} Verifies that users can begin the assessment after they complete all setup steps, including the tutorial. \par
