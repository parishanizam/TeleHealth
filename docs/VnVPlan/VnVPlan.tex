...
\begin{table}[hp]
  ...
  11/04/24 & 1.4 & Jasmine Sun-Hu & Added:\begin{itemize}[leftmargin=*]
    ...
    \item Reflection
  \end{itemize}\\
  11/04/24 & 1.5 & Promish Kandel & Added:\begin{itemize}[leftmargin=*]
    \item section 1 Symbols, Abbreviations and Acronyms
    \item Reflection
  \end{itemize}\\
  \bottomrule
  \end{tabularx}
...
\begin{itemize}
  ...
  \begin{mdframed}[linewidth=0.5mm]
      ...
      \textbf{Output/Results:} The expect output is that each web page loads fully with all functionalities within MAX\_LOAD\_TIME. \par
      \textbf{How the test will be performed:}
      \begin{enumerate}[noitemsep]
  ...
  \begin{mdframed}[linewidth=0.5mm]
      ...
      \textbf{Output/Results:} The exepect output is the video quality is at least \\AVERAGE\_RESOLUTION upon when retriving or storing. \par
      \textbf{How the test will be performed:}
      \begin{enumerate}[noitemsep]
