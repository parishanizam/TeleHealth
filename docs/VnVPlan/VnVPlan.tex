...
\begin{table}[hp]
  ...
  03/23/25 & 2.2 & Jasmine Sun-Hu & Implemented Peer Feedback: \href{https://github.com/parishanizam/TeleHealth/issues/224}{Added test case derivations to NFRs}, \href{https://github.com/parishanizam/TeleHealth/issues/223}{Clarified objectives}, \\
  \bottomrule
  \end{tabularx}
\end{table}
