...
\begin{itemize}
  \begin{item}
      ...
      \begin{mdframed}[linewidth=0.5mm]
          \textbf{Control:} Manual vs Automatic \par
          \textbf{Initial State:}  \par
          \textbf{Input:}  \par
          \textbf{Output:} The expected results for the testcase not how you are getting results\par
          \textbf{Test Case Derivation:} Justify expected value giveint in the output field \par
