...
\begin{table}[hp]
  ...
  \end{itemize}\\
  11/01/24 & 1.2 & Jasmine Sun-Hu & Added:\begin{itemize}[leftmargin=*]
  ...
  \end{itemize}\\
  11/02/24 & 1.3 & Mitchell Weingust & Added:\begin{itemize}[leftmargin=*]
  ...
  \end{itemize}\\
  11/04/24 & 1.4 & Mitchell Weingust & Added:\begin{itemize}[leftmargin=*]
    \item Reflection
  \end{itemize}\\
  11/04/24 & 1.5 & Jasmine Sun-Hu & Added:\begin{itemize}[leftmargin=*]
    \item 6.1 Symbolic Parameters
    \item Reflection
  \end{itemize}\\
  11/04/24 & 1.6 & Promish Kandel & Added:\begin{itemize}[leftmargin=*]
...
This document contains the team's verification and validation plan for the TeleHealth
...
Section 5, Unit Test Description, will be filled in prior to the revision 0 deliverable. The team decided to leave in the template instructions as a guide to indicate our desried return to the document.\\
